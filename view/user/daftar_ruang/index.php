                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                ...
                                <form method="get" action ="<?php echo base_url('daftar_ruang/search') ?>" >
                                    <input type="text" name="txtsearch" value="<?php echo $search ?>" style="width:180px" class="form-control" placeholder="Search for...">
                                ...
                                <div class="x_title">
                                    <div class="col-md-8 col-sm-7 col-xs-6 text-right">
                                     ...
                                     <form method="get" class="form-inline" action="<?php echo base_url('daftar_ruang') ?>">
                                         <?php echo form_dropdown('id_kampus' , $kampus_option,$id_kampus,' class="form-control" style="width:180px" onchange="" '); ?>
                                           <span class="input-group-btn">
                                          <input class="btn btn-default" type="submit" value="Find">
                                          </span>
                                     </form>   
