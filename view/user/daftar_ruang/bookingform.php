        <h2 style="margin-top:0px">Pemesanan Ruang</h2>
	    ...
	    <div class="form-group">
                <label for="time">Jam Mulai (HH.MM) <?php echo form_error('jam_mulai') ?></label>
                <input type="text" class="form-control" name="jam_mulai" id="jam_mulai" placeholder="jam_mulai" value="<?php echo $jam_mulai; ?>" />
            </div>
	    <div class="form-group">
                <label for="time">Jam Selesai (HH.MM) <?php echo form_error('jam_selesai') ?></label>
	    ...
	    <a href="<?php echo site_url('daftar_ruang') ?>" class="btn btn-default">Cancel</a>
	</form>
